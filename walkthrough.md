...
- **UI/UX 고도화 및 다국어 지원**:
  - 다크 모드 카드 디자인과 탭 스위처를 10대 테마로 확장 적용하고, [ko.json](file:///c:/Users/TAEJIN/Documents/f-core/web/messages/ko.json) 및 [en.json](file:///c:/Users/TAEJIN/Documents/f-core/web/messages/en.json) 로케일 번역 키 추가를 완료했습니다.
